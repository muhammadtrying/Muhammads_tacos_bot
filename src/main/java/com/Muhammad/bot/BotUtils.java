...
public class BotUtils {
    ...
    public static Keyboard generateBackButton(TelegramUser telegramUser) {
        ReplyKeyboardMarkup replyKeyboardMarkup = new ReplyKeyboardMarkup(new KeyboardButton(telegramUser.getText("BACK")));
        replyKeyboardMarkup.resizeKeyboard(true);
        return replyKeyboardMarkup;
    }
}
